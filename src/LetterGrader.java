...
public class LetterGrader {
	...
	//Avg, Min, and Max variables for each assignment  
	private double quiz1Avg = 0; 
	private int quiz1Min = 101;
	private int quiz1Max = -1;
	private double quiz2Avg = 0;
	private int quiz2Min = 101;
	private int quiz2Max = -1;
	private double quiz3Avg = 0;
	private int quiz3Min = 101;
	private int quiz3Max = -1;
	private double quiz4Avg = 0;
	private int quiz4Min = 101;
	private int quiz4Max = -1;
	private int midiMin = 101;
	private int midiMax = -1;
	private double midiAvg = 0;
	private double midiiAvg = 0;
	private int midiiMin = 101;
	private int midiiMax = -1;
	private double finalTestAvg = 0;
	private int finalTestMin = 101;
	private int finalTestMax = -1;
	
	//Create LetterGrader. Set input and output to args. Print notification to the user 
	public LetterGrader(String arg1, String arg2) {
		this.inputFile = arg1;
		this.outputFile = arg2; 	
	}
	
	//Method that Reads and CreateStudents
	public void ReadandCreateStudents(){
		BufferedReader reader = null;
		String line = "";
		//Values are separated by "," and a " "
		String splitBy = ", ";
		try {
			...
			out.println("There is an issue with your input file. Please make sure it is in the correct directory.");
			System.exit(1);
		} finally {
			try {
				//Close reader 
	...
	//After  all of the students are in the arrayList, sort on the student's name
	...
	public void displayAvg(){
		...
		out.printf("Letter grade has been calculated for students listed in the input file %s and outputted in the output file %s.\n\n", inputFile, outputFile);
		out.print("Here are the class averages:\n\n");
		//Print out headers for the data 
		...
		for(int i = 0; i < numberOfAssignments; i++ ){
			...
			for(int s = 0; s < studentList.size(); s++){
				...
				//when the quizAvgTotal has all of the assignments then calculate assignment average
	...
	public void printGrades(){
		try {
		    ...
		    out.print("There is an issue with your output file.");
