...
//Student class implements comparable for sorting
class Students implements Comparable<Students>  {
	...
	//get scores for all assignments 
	 public String getQuiz(int i) {  
		 ...
		 case 6: 
			 return finalTest;
		 default:return "Error in format";
		 }
	 }  
	  
	 //Getters and setters for assignments 
	...
	@Override
	//Class required this method to run 
	public int compareTo(Students compareStudents) {
		// TODO Auto-generated method stub
		return 0;
	}
	//Compare students and sort 
